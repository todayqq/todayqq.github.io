...
# SNS settings      
github_username: angkee     # 你的github账号
weibo_username: angkee      # 你的微博账号，底部链接会自动更新的。
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了，详情请见：
  [issue #6 ](https://github.com/angkee/angkee.github.io/issues/6) asked, **how to make it looks great?**
